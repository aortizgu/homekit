...
import (
	...
	_ "homekit/app"
	controllers2 "homekit/app/controllers"
	_ "homekit/app/jobs"
	_ "homekit/app/msgbroker"
...
func Register() {
	...
	revel.RegisterController((*controllers2.Dashboard)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "Index",
				Args: []*revel.MethodArg{ 
	...
	revel.RegisterController((*controllers2.Rules)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "Index",
				Args: []*revel.MethodArg{ 
			...
			&revel.MethodType{
				Name: "GetDeviceRules",
				Args: []*revel.MethodArg{ 
					&revel.MethodArg{Name: "device", Type: reflect.TypeOf((*string)(nil)) },
				},
				RenderArgNames: map[int][]string{ 
					85: []string{ 
						"device",
	...
	revel.DefaultValidationKeys = map[string]map[int]string{ 
		"homekit/app/models.(*User).Validate": { 
			29: "user.Username",
			37: "user.Name",
		},
		"homekit/app/models.ValidatePassword": { 
			45: "password",
		},
	}
